...
; File associations for media files
Root: HKCR; Subkey: ".mp3"; ValueType: string; ValueName: ""; ValueData: "BobMediaPlayer.mp3"; Flags: uninsdeletevalue; Tasks: associate
Root: HKCR; Subkey: ".wav"; ValueType: string; ValueName: ""; ValueData: "BobMediaPlayer.wav"; Flags: uninsdeletevalue; Tasks: associate
Root: HKCR; Subkey: ".m4a"; ValueType: string; ValueName: ""; ValueData: "BobMediaPlayer.m4a"; Flags: uninsdeletevalue; Tasks: associate
Root: HKCR; Subkey: ".wma"; ValueType: string; ValueName: ""; ValueData: "BobMediaPlayer.wma"; Flags: uninsdeletevalue; Tasks: associate
...
Root: HKCR; Subkey: "BobMediaPlayer.mp3"; ValueType: string; ValueName: ""; ValueData: "MP3 Audio File"; Flags: uninsdeletekey; Tasks: associate
Root: HKCR; Subkey: "BobMediaPlayer.mp3\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#MyAppExeName},0"; Tasks: associate
Root: HKCR; Subkey: "BobMediaPlayer.mp3\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" ""%1"""; Tasks: associate

Root: HKCR; Subkey: "BobMediaPlayer.wav"; ValueType: string; ValueName: ""; ValueData: "WAV Audio File"; Flags: uninsdeletekey; Tasks: associate
Root: HKCR; Subkey: "BobMediaPlayer.wav\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#MyAppExeName},0"; Tasks: associate
Root: HKCR; Subkey: "BobMediaPlayer.wav\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" ""%1"""; Tasks: associate

Root: HKCR; Subkey: "BobMediaPlayer.m4a"; ValueType: string; ValueName: ""; ValueData: "M4A Audio File"; Flags: uninsdeletekey; Tasks: associate
Root: HKCR; Subkey: "BobMediaPlayer.m4a\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#MyAppExeName},0"; Tasks: associate
Root: HKCR; Subkey: "BobMediaPlayer.m4a\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" ""%1"""; Tasks: associate

Root: HKCR; Subkey: "BobMediaPlayer.wma"; ValueType: string; ValueName: ""; ValueData: "WMA Audio File"; Flags: uninsdeletekey; Tasks: associate
Root: HKCR; Subkey: "BobMediaPlayer.wma\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#MyAppExeName},0"; Tasks: associate
Root: HKCR; Subkey: "BobMediaPlayer.wma\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" ""%1"""; Tasks: associate
