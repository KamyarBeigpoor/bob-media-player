...
OutFile "BobMediaPlayer-Setup-1.3.1.exe"
Unicode True
...
VIAddVersionKey "FileDescription" "A simple media player"
...
Section "BOB Media Player (required)" SecMain
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\BOB Media Player" "DisplayVersion" "1.3.1"
